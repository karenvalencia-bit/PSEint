Algoritmo conversiones
	...
	Definir hexa, octal, binario, decimal2, letra Como Caracter;
	definir resultado, result2 Como entero; // se definen variables para almacenar los resultados
	definir i, x, z, l, s Como Entero; //se definen contadores
	...
	Repetir
		...
		Segun resp2 Hacer //segun lo que responda el usuario se ejecutara la accion correspondiente
			1:
				...
				si base >3 Entonces
					Escribir "recuerda que las elecciones son 1,2,3";
				FinSi
				...
				escribir "ingrese un numero ";// se pide que ingrese un numero
				Escribir "si es un numero es base octal debe ser de tres cifras EJ:234";
				escribir  "si es una conversion de decimal a binario solo esta disponible hasta el 1000";//se limita al usuario en la base octal
			...
			2:
				...
				Segun resp3 Hacer//segun la opcion elegida por el usuario se realiza la acción correspondiente
					1:
						Escribir "digite un numero base 10 de 1 a 9, sin puntos ni comas "; //se pide el numero
						leer n2; //se captura el numero
						
						si n2 == 1 Entonces
							Escribir "el numero ingresado en xs3 es: 0100";
						FinSi
						
						si n2 == 2 Entonces
							Escribir "el numero ingresado en xs3 es: 0101 ";
						FinSi
						
						si n2 == 3 Entonces
							Escribir "el numero ingresado en xs3 es: 0110 ";
						FinSi
						
						si n2 == 4 Entonces
							Escribir "el numero ingresado en xs3 es: 0111";
						FinSi
						
						si n2 == 5 Entonces
							Escribir "el numero ingresado en xs3 es: 1000";
						FinSi
						
						si n2 == 6 Entonces
							Escribir "el numero ingresado en xs3 es: 1001";
						FinSi
						
						si n2 == 7 Entonces
							Escribir "el numero ingresado en xs3 es: 1010";
						FinSi
						
						si n2 == 8 Entonces
							Escribir "el numero ingresado en xs3 es: 1011";
						FinSi
						
						si n2 == 9 Entonces
							Escribir "el numero ingresado en xs3 es: 1100";
						FinSi
		...
		Escribir "¿Desea continuar? S mayuscula para indicar un si/ N para indicar un no";
		Leer letra;
	Hasta Que  letra <> "S";
	Escribir "Ya has terminado o no has ingresado bien la respuesta";
